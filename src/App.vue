  ...
  >
    ...
    <header class="top">
      ...
      <div class="som">
        <div
          class="areaHoverBt"
          @mouseover="hoverBt = true"
          @mouseleave="hoverBt = false"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="42"
